//#line 2 "/home/pi/ros_catkin_ws/install_isolated/share/dynamic_reconfigure/cmake/../templates/ConfigType.h.template"
// *********************************************************
// 
...
//#line 280 "/home/pi/ros_catkin_ws/install_isolated/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      int debayer;
//#line 218 "/home/pi/ros_catkin_ws/install_isolated/share/dynamic_reconfigure/cmake/../templates/ConfigType.h.template"
...
//#line 280 "/home/pi/ros_catkin_ws/install_isolated/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum_description': 'Debayering algorithm', 'enum': [{'srcline': 10, 'description': 'Fast algorithm using bilinear interpolation', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Bilinear'}, {'srcline': 12, 'description': 'Edge-aware algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'EdgeAware'}, {'srcline': 14, 'description': 'Weighted edge-aware algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'EdgeAwareWeighted'}, {'srcline': 16, 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'VNG'}]}", &DebayerConfig::debayer)));
//#line 280 "/home/pi/ros_catkin_ws/install_isolated/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum_description': 'Debayering algorithm', 'enum': [{'srcline': 10, 'description': 'Fast algorithm using bilinear interpolation', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Bilinear'}, {'srcline': 12, 'description': 'Edge-aware algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'EdgeAware'}, {'srcline': 14, 'description': 'Weighted edge-aware algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'EdgeAwareWeighted'}, {'srcline': 16, 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'srcfile': '/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'VNG'}]}", &DebayerConfig::debayer)));
//#line 235 "/home/pi/ros_catkin_ws/install_isolated/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 353 "/home/pi/ros_catkin_ws/install_isolated/share/dynamic_reconfigure/cmake/../templates/ConfigType.h.template"
...
//#line 10 "/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_Bilinear = 0;
//#line 12 "/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAware = 1;
//#line 14 "/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAwareWeighted = 2;
//#line 16 "/home/pi/Phoenix/drone_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
